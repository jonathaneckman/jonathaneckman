...
const CloseIcon: IconComponent = ({...rest}) => {
  return (
...
const ChevronDownIcon: IconComponent = ({...rest}) => {
  return (
...
const SunIcon: IconComponent = ({...rest}) => {
  return (
    <svg
      viewBox="0 0 24 24"
      strokeWidth="1.5"
...
const MoonIcon: IconComponent = ({...rest}) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...rest}>
      <path
...
const DesktopNavigation = (props: React.HTMLAttributes<HTMLElement>) => {
  return (
    <nav {...props}>
...
const AvatarContainer = ({ className = "", ...props }: {className?: string} & React.HTMLAttributes<HTMLDivElement>) => {
  return (
    <div
      className={clsx(
        className,
...
const Avatar = ({ large = false, className = "", ...props }: {large?: boolean, className?: string}) => {
  return (
    <Link
      href="/"
      aria-label="Home"
